const SCHOLARS = [
  ...
  },
  {
    ...
    uni: 'University of Cambridge', dept: 'Faculty of Classics',
    city: 'Cambridge', position: 'Senior Lecturer in Classics (Greek and Roman Philosophy)',
    focus: 'Aristotle', ancients: ['Aristotle', 'Alexander of Aphrodisias'],
  ...
  },
  {
    ...
    city: 'London', position: 'Reader in Greek and Roman Philosophy',
  ...
  /* ── Oxford ───────────────────────────────────────────── */
  {
    ...
    city: 'Oxford', position: 'Fellow and Tutor in Greek and Roman Philosophy',
  ...
  },
  {
    name: 'Ursula Coope',
    uni: 'University of Oxford', dept: 'Faculty of Philosophy',
    city: 'Oxford', position: 'Professor of Greek and Roman Philosophy',
    focus: 'Aristotle', ancients: ['Aristotle'],
  ...
  },
  {
    name: 'Lindsay Judson',
    uni: 'University of Oxford', dept: 'Faculty of Philosophy',
    city: 'Oxford', position: 'Emeritus Professor of Greek and Roman Philosophy',
    focus: 'Aristotle', ancients: ['Aristotle', 'Plato'],
    tags: ['metaphysics', 'epistemology'],
  ...
  },
  {
    name: 'Marion Durand',
    uni: 'University of Oxford', dept: 'Faculty of Philosophy',
    city: 'Oxford', position: 'Associate Professor of Greek and Roman Philosophy',
    focus: 'Hellenistic', ancients: ['Stoicism'],
    tags: ['language', 'epistemology'],
  ...
  },
  {
    ...
    uni: 'University of Oxford', dept: 'Faculty of Philosophy',
    city: 'Oxford', position: 'Departmental Lecturer in Greek and Roman Philosophy',
    focus: 'Hellenistic', ancients: ['Pyrrhonian Scepticism', 'Academic Scepticism'],
    tags: ['epistemology'],
  ...
  {
    name: 'Simon Trépanier', dept: 'School of History, Classics and Archaeology',
  ...
  /* ── St Andrews ───────────────────────────────────────── */
  {
    ...
    city: 'St Andrews', position: 'Lecturer in Greek and Roman Philosophy',
    focus: 'Aristotle', ancients: ['Aristotle'],
    tags: ['ethics', 'mind'],
...
/* ── Specialism cards (Browse by specialism tab) ─────────
   key         matches values in SCHOLARS.ancients
               (cards are now keyed on ancients, not focus)
   img         public-domain image URL                      */
const PHILOSOPHERS = [
  {
    key: 'Socrates', label: 'Socrates', dates: 'c. 470–399 BCE',
    blurb: 'The examined life, dialectic, ethics',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Socrates_Louvre.jpg?width=320',
  },
  {
  ...
  {
    key: 'Alexander of Aphrodisias', label: 'Alexander of Aphrodisias', dates: 'c. 200 CE',
    blurb: 'Commentator on Aristotle',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Aristotle_Altemps_Inv8575.jpg?width=320',
  },
  {
    key: 'Stoicism', label: 'Stoicism', dates: 'c. 300 BCE –',
    blurb: 'Zeno, Chrysippus, Marcus Aurelius, Seneca',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/MSR-ra-1-Zeno_of_Citium.jpg?width=320',
  },
  {
    key: 'Epicureanism', label: 'Epicureanism', dates: 'c. 307 BCE –',
    blurb: 'Epicurus, Lucretius, Philodemus',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Epikouros_BM_1843.jpg?width=320',
  },
  {
    key: 'Scepticism', label: 'Scepticism', dates: 'c. 360 BCE –',
    blurb: 'Pyrrho, Arcesilaus, Sextus Empiricus',
    subsections: ['Pyrrhonian Scepticism', 'Academic Scepticism'],
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sextus_empiricus.jpg?width=320',
  },
  {
    key: 'Neoplatonism', label: 'Neoplatonism', dates: 'c. 3rd–6th c. CE',
    blurb: 'Plotinus, Porphyry, Proclus',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Plotinos.jpg?width=320',
  },
  {
    key: 'Cynicism', label: 'Cynicism', dates: 'c. 400–300 BCE',
    blurb: 'Diogenes of Sinope, Antisthenes',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Diogenes_Sinope_BM_1842.jpg?width=320',
  },
  {
    key: 'Cyrenaics', label: 'Cyrenaics', dates: 'c. 400–300 BCE',
    blurb: 'Aristippus, pleasure and the good life',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Aristippus.jpg?width=320',
  },
  {
    key: 'Philodemus of Gadara', label: 'Philodemus of Gadara', dates: 'c. 110–40 BCE',
    blurb: 'Epicurean philosopher, Herculaneum papyri',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Epikouros_BM_1843.jpg?width=320',
  },
  {
    key: 'Heraclitus', label: 'Heraclitus', dates: 'c. 535–475 BCE',
    blurb: 'Flux, logos, the unity of opposites',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Heraclitus_Ephesus.jpg?width=320',
  },
  {
    key: 'Parmenides', label: 'Parmenides', dates: 'c. 515–450 BCE',
    blurb: 'Being, monism, the way of truth',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Parmenides.jpg?width=320',
  },
  {
    key: 'Democritus', label: 'Democritus', dates: 'c. 460–370 BCE',
    blurb: 'Atomism, materialism',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Democritus2.jpg?width=320',
  },
  {
    key: 'Empedocles', label: 'Empedocles', dates: 'c. 490–430 BCE',
    blurb: 'Four roots, Love and Strife',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Empedocles_in_Thomas_Stanley_History_of_Philosophy.jpg?width=320',
  },
  {
    key: 'Protagoras', label: 'Protagoras', dates: 'c. 490–420 BCE',
    blurb: 'Sophist, relativism, "man is the measure"',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Protagoras.jpg?width=320',
  },
  {
    key: 'Xenophanes', label: 'Xenophanes', dates: 'c. 570–475 BCE',
    blurb: 'Theology, epistemology, natural philosophy',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Xenophanes.jpg?width=320',
  },
  {
    key: 'Anaximander', label: 'Anaximander', dates: 'c. 610–546 BCE',
    blurb: 'The apeiron, cosmology',
    img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Anaximander.jpg?width=320',
  },
];
