...
const EMERITI = [
  ...
  },
  {
    ...
    focus: 'Epicureanism', ancients: ['Epicureanism', 'Philodemus of Gadara'],
    tags: [],
    email: 'Robert.Fowler@bristol.ac.uk', web: '',
    links: [{ label: 'Faculty page', url: 'https://www.bristol.ac.uk/classics/people/fowler.html' }],
    photo: 'https://res.cloudinary.com/dspfaec6d/image/upload/c_thumb,g_face,z_0.4,w_400,h_400/v1778455187/robert-l-fowler-1778455186928.jpg',
  },
];
