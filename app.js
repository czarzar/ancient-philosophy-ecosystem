...
/* ── Display name, with a dagger for deceased scholars ── */
function nameHtml(s) {
  return s.name + (s.deceased ? '\u00a0†' : '');
}
...
function openModal(scholar) {
  ...
  /* Text */
  document.getElementById('modal-name').textContent  = nameHtml(s);
